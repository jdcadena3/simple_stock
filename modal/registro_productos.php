	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar nuevo producto al stock</h4>
		  </div>
		  <div class="modal-body">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label for="bodega" class="col-sm-3 control-label">Bodega</label>
				<div class="col-sm-8">
					<textarea class="form-control" id="bodega" name="bodega" placeholder="Bodega" required maxlength="22" ></textarea>
