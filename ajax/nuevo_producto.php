...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, date_added, precio_producto, stock, id_categoria, bodega) VALUES ('$codigo','$nombre','$date_added','$precio_venta', '$stock','$id_categoria','$bodega')";
